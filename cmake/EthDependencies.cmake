...
find_package(Boost 1.54.0 QUIET COMPONENTS regex filesystem unit_test_framework program_options system)
if(NOT ${Boost_FOUND})
	message("-- Using HUNTER package manager to detect BOOST libraries")
	hunter_add_package(Boost COMPONENTS regex filesystem program_options system test)
	find_package(Boost CONFIG REQUIRED regex filesystem program_options system unit_test_framework)
else()
	message("-- Found boost without a hunter. You are lucky.")
endif()
